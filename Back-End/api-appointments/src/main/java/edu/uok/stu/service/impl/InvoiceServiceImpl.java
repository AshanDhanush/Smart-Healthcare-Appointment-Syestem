...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    <head>
        ...
        <style>
            ...
            .label { font-weight: bold; color: #475569; width: 140px; font-size: 13px; text-align: left; padding: 6px 0; }
            .value { color: #334155; font-size: 13px; text-align: left; padding: 6px 0; }
    ...
    <body>
        ...
        <div class="section">
            <table class="patient-table">
                <tr>
                    ...
                    <td class="value">""").append(patientName).append("""
                    </td>
                    <td class="label">Date:</td>
                    <td class="value">""").append(date.toString()).append("""
                    </td>
                </tr>
                <tr>
                    <td class="label">Patient Email:</td>
                    <td class="value">""").append(patientEmail).append("""
                    </td>
                    <td class="label">Appointment Number:</td>
                    <td class="value">#""").append(number).append("""
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table class="details-table">
            ...
            <tbody>
                <tr>
                    <td>Dr. """).append(doctorName).append("<br /><small style=\"color: #64748b;\">Room: ").append(roomNumber).append("""
                    </small></td>
                    <td>""").append(specialization).append("""
                    </td>
                    <td style="text-align: right; font-weight: bold;">Rs. """).append(String.format("%.2f", consultationFee)).append("""
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="total-section">
            <p style="font-size: 13px; color: #64748b;">Subtotal: Rs. """).append(String.format("%.2f", consultationFee)).append("""
            </p>
